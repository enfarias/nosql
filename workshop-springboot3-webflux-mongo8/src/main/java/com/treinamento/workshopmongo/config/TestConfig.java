...
/*
	 	...
	 	//Código para realizar operações de exclusão e inclusão como chamadas isoladas   	
...
*/
 		...
 		//Código que forma uma única cadeia reativa contínua
		...
		.flatMapMany(users -> {           // Step 4: Encadeia o salvamento de posts
			...
			//Instancia os posts utilizando o Author com o ID salvo da Maria
